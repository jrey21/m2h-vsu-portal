...
const HomeTab: React.FC<HomeTabProps> = ({ session }) => {
        ...
        >
            <View style={styles.tabContent}>
                ...
                <View style={styles.welcomeHeader}>
                    <View style={styles.welcomeContent}>
                        ...
                        <Text style={styles.userName}>
                            {userData?.occupant.first_name || 'Jason Rey'}!
                        </Text>
                ...
                <View style={styles.card}>
                    ...
                    <Text style={styles.roomNumber}>Metro Manila</Text>
                    <Text style={styles.roomDetails}>Level 3</Text>
                    <Text style={styles.roomAssigned}>
                        Assigned since: 1st Semester (2025-2026)
                    </Text>
                    <Text style={[styles.statusBadge, styles.activeBadge]}>Active</Text>
                </View>
